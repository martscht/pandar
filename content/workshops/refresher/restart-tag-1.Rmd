...
```{r Settings, echo=FALSE, warning = FALSE}
library(knitr)
data <- data.frame(
...
```{r Datentypen, echo=FALSE, message=FALSE}
library(knitr)
data5 <- data.frame(
...
Der Modus der Variable `auge` lautet braun, die Ausprägung trat `r max(table(workshopfb$auge))`-mal auf. ##aktualisieren
