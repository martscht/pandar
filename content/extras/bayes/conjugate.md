...
![](/extras/bayes/conjugate_files/figure-html/unnamed-chunk-32-1.png)<!-- -->
...
![](/extras/bayes/conjugate_files/figure-html/unnamed-chunk-33-1.png)<!-- -->
...
Als [starker Prior](/extra/bayes/bayes-intro#starke-prior) hatte im Beispiel $\text{Beta}(6, 6)$ hergehalten.
...
![](/extras/bayes/conjugate_files/figure-html/unnamed-chunk-41-1.png)<!-- -->
...
In diesem Bereich findet sich also eher wenig Evidenz. Wie genau diese Information gneutzt werden kann, um auch Aussagen bezüglich der Gültigkeit von Nullhypothesen zu machen, sehen wir in einem späteren Beitrag.
