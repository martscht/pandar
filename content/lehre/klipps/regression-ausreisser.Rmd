...
Das standardisierte Regressionsgewicht der Lebenszufriedenheit $\beta_\text{Lebenszufriedenheit}$ liegt bei `r round(coef(lm.beta(model))[3], 4)`, was bedeutet, dass bei einer Erhöhung der Lebenszufriedenheit um eine Standardabweichung die Depressivitaet im Mittel (im Durchschnitt) um `r round(coef(lm.beta(model))[3], 4)` Standardabweichungen fällt. 
