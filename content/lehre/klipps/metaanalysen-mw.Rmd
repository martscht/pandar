...
Der Moderator scheint keinen signifikanten Heterogenitätsvarianzanteile zu erklären ($Q_M(df=1)=$ `r round(MEM1$QM, 2)`, $p=$, `r round(MEM1$QMp, 4)`). Insgesamt werden nur $3.05\%$ Heterogenitätsvariation durch die Intensität erklärt. Unter 
