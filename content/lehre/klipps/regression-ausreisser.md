...
##           0.9176556           0.9176556
```
In diesem Beispiel mit nur 2 Prädiktoren ist $R_{Geschlecht}^2=R_{Lebenszufriedenheit}^2=cor(\text{Geschlecht},\text{Lebenszufriedenheit})^2$ und die Formeln sind daher sehr einfach auch mit Hand zu bestimmen:
