...
summary: 'Zur Erweiterung des Verständnisses multivariater Verfahren wird in diesem Beitrag mit dem package `lavaan` gearbeitet, welches unter anderem auch für konfirmatorische Faktorenanalysen und Strukturgleichungsmodelle genutzt werden kann. Zum Einstieg gibt es zuerst eine Auffrischung der R-Kenntnisse, insbesondere auch zu multiplen Regressionen.' 
