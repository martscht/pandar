...
summary: 'Aufbauend auf [unserem Verständnis der Strukturgleichungsmodelle(SEM)](/lehre/fue-ii/sem) handelt dieser Beitrag von der Multipe-Sample-Analysis, mit der die SEM auf mehreren Gruppen gleichzeitig geschätzt werden können. Als Gruppierung wird hier zuerst das Geschlecht genutzt, aus den Daten der letzten Sitzung zum Stress auf der Arbeit. Abschließend wird eine Fragestellung des Verfahrens noch mit einer moderierten Regression verglichen.' 
