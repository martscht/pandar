...
```{r Leeres-Balkendiagramm, fig=TRUE, echo=-1, height = 4, width = 6}
...
```{r Erweitertes-Balkendiagramm, fig=TRUE, echo = -1}
# Erste Ästhetik (x-Achse) festlegen
ggplot(edu_2014, aes(x = Wealth))
```
...
```{r Einfacher-Scatterplot, fig=TRUE, echo=-1}
...
```{r Gestapeltes-Balkendiagramm, fig=TRUE}
...
```{r Gruppiertes-Balkendiagramm, fig=TRUE}
ggplot(edu_2014, aes(x = Wealth, group = Region)) +
