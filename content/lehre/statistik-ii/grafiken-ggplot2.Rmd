...
```{r Leeres-Balkendiagramm, fig=TRUE, echo=-c(1,2), height = 4, width = 6}
...
```{r Erweitertes-Balkendiagramm, fig=TRUE, echo =-c(1,2)}
...
```{r Einfacher-Scatterplot, fig=TRUE, echo=-c(1,2)}
...
```{r Gestapeltes-Balkendiagramm, fig=TRUE, echo=-1}
...
```{r Gruppiertes-Balkendiagramm, fig=TRUE, echo=-1}
