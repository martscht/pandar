...
```{r simple-scatter, fig = TRUE, echo = -1}
# Einfacher Scatterplot
...
```{r scatterplot-colored, fig = TRUE, echo = -1}
...
```{r scatterplot-sized, fig = TRUE, echo = -1}
