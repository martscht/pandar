...
Der Rest der Formel ist ein wenig komplizierter. $\bar{x}$ ist ein Vektor mit allen Mittelwerten der Prädiktoren und $x$ ist ein Vektor mit den Werten der Prädiktoren, für den wir die Vorhersage machen wollen. $X_i$ repräsentiert die Werte der Prädiktoren für alle Personen aus der ursprünglichen Modellierung.
...
Übertragen wir die Formel per Hand in R Code ergibt sich folgendes:
