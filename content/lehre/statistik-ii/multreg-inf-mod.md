...
subtitle: ''
summary: 'In dieser Sitzung geht es einerseits um die Betrachtung eines Regressionsmodell am konkreten Beispiel. Andererseits geht es um hypothesengeleitete und explorative Modelloptimierung, durch die möglichst viel der Varianz der abhängigen Variable erklärt werden soll.'
