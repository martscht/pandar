...
subtitle: ''
summary: 'Im Fokus dieser Sitzung steht die Überprüfung von Voraussetzungen im Rahmen der Regressionsdiagnostik. Dies umschließt Messfehlerfreiheit, Residuenunabhängigkeit, Linearität, Homoskedazidizität und Normalverteilung der Residuen und erweiternd auch Multikollinearität und Ausreißerdiagnostik.'
...
Den Koeffizienten entnehmen wir, dass die Prädiktoren `female` und `IQ` signifikante Anteile am Kriterium erklären. Insgesamt werden `r round(stdsum$r.squared*100, 2)`% der Variation der Leseleistung durch die beiden Prädiktoren erklärt.
