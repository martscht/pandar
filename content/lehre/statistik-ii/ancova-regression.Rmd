...
subtitle: ''
summary: 'In diesem Beitrag wird das bisherige Verständnis der ANOVA um die Einbindung nominalskalierter Prädiktoren erweitert und eine ANCOVA präsentiert. Von besonderem Interesse ist hierbei die ermöglichte Kombination nominalskalierter und intervallskalierter Variablen, da dies in der psychologischen Forschung häufig Anwendung findet.'
authors: [schultze]
weight: 11
lastmod: '`r Sys.Date()`'
featured: no
