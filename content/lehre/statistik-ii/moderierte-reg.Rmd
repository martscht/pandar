...
In der Tat sagt der IQ statistisch signifikant die Leseleistung vorher ($\beta$ = `r coef(mod1)[2] |> round(2)`, $p < .001$).
Wenn der IQ um 1 Standardabweichung (SD) steigt, erhöht sich laut diesem Output auch die Lesefähigkeit um `r coef(mod1)[2] |> round(2)` SD.
...
<summary>**Formelbasierte Vertiefung zur moderierten Regression**</summary>
...
<summary>**Code zu 3D-Grafiken**</summary>
