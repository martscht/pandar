...
subtitle: ''
summary: 'In dieser Sitzung wird die Gewichtung von Variablen in der Regression besprochen. Verschiedene Anwendungsfälle und allgemeine Motivationen für die Anwendung einer gewichtete Regression werden aufgegriffen mit einem Ausblick auf verschiedene Gewichtungsarten und die Anwendung auf mehrere Variablen.'
authors: [kvetnaya]
weight: 13
lastmod: '`r Sys.Date()`'
featured: no
