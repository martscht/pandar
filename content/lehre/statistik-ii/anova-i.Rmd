...
summary: 'In diesem Beitrag wird die ANOVA eingeführt, mit der Mittelwertsunterschiede über mehrere Gruppen untersucht werden können.'
...
In unserem Datensatz liegt leider noch keine ID-Variable vor, diese muss also zunächst erstellt werden. Der Einfachheit halber nummerieren wir die Personen von 1 bis `r nrow(conspiracy)` durch. 
