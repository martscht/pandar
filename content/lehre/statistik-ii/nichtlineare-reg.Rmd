...
subtitle: ''
summary: 'In dieser Sitzung stehen nichtlineare Effekte im Fokus. Quadratische Verläufe, Interaktionseffekte und exponentielle Verläufe der Regression werden nacheinander erläutert. Es werden dabei auch Verfahren und Transformationen zur Untersuchung jener Verläufe aufgeführt, wie etwa die moderierte Regression für die Interaktionseffekte.'
...
```{r, echo= F, fig.align="center", fig.height=6, purl=FALSE}
...
```{r, echo = F, purl=FALSE}
knitr::kable(round(head(Schulleistungen),2))
```
...
```{r, echo = F, fig.align="center", fig.height=6, message=F, warning = F, purl=FALSE}
library(plot3D)
# x, y, z variables
