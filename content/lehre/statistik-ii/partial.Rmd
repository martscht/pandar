...
In der Tat zeigen die Ergebnisse, dass der Neurotizismus sowohl mit der Lebenszufriedenheit (`r cor(dat$Neurotizismus, dat$Lebenszufriedenheit) |> round(2)`) als auch mit Depressivität (`r cor(dat$Neurotizismus, dat$Depressivitaet) |> round(2)`) statistisch bedeutsam korreliert.
...
# Infos aus pcor.test
pcortest <- pcor.test(
  dat$Depressivitaet, dat$Lebenszufriedenheit,
  dat$Neurotizismus
)
# correlation r
