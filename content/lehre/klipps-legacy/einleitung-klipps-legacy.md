...
links:
  - icon_pack: fas
    icon: book
    name: Inhalte
    url: /lehre/klipps-legacy/einleitung-klipps-legacy
  - icon_pack: fas
    icon: terminal
    name: Code
    url: /lehre/klipps-legacy/einleitung-klipps-legacy.R
#   - icon_pack: fas
#     icon: user-graduate
#     name: Aufgaben
