...
<!-- includes a workaround to avoid errors with car functions residualPlots and avPlots -->
<!-- loads the data set Schulleistungen into the global environment and also removes it afterwards -->
...
```{r, echo = F, purl = F}
rm(Schulleistungen, envir= globalenv())
``` 
***
