...
## X1    1 125  3.1 0.62   3.17     3.1 0.74 1.5 4.67  3.17 -0.05    -0.13 0.06
## -------------------------------------------------------------------------------- 
## group: männlich
##    vars  n mean   sd median trimmed  mad  min max range  skew kurtosis   se
## X1    1 23 3.37 0.69   3.33     3.4 0.74 1.83 4.5  2.67 -0.34    -0.71 0.14
```
...
## group: männlich
##    vars  n mean   sd median trimmed  mad min max range  skew kurtosis   se
## X1    1 23 3.39 1.12      4    3.47 1.48   1   5     4 -0.58    -0.37 0.23
```
