...
`N` hatten wir oben bereits als `r N` festgelegt. Mit `replicate()` können  wir den Code beliebig häufig durchführen. Z.B. zunächst 10 mal:
...
```{r, fig = TRUE, echo = F, purl = F, fig.align="center", fig.height=10, fig.width=10, warning=FALSE, message=FALSE}
library(pwr)
Erg <- c()
...
Wir bräuchten also eine Mittelwertsdifferenz von `r wp.t(n1 = 20, power = .8, type = "two.sample", alternative = "two.sided")$d`. 
