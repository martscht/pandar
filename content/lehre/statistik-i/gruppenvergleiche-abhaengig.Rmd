...
```{r, echo = FALSE, purl = F}
ttest <- t.test(x = fb24$ru_post, y = fb24$ru_pre,
...
```{r, echo = FALSE, purl = F}
wilcox <- wilcox.test(x = fb24$time_pre, y  = fb24$time_post, paired = T, alternative = "greater", conf.level = .95)
```
