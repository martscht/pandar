...
Die Effektgröße ist mit `r round(d2, digits = 2)` nach Cohen (1988) als klein einzuordnen.
...
Das 95%-ige Konfidenzintervall liegt zwischen `r round(conf_int[1], digits = 2)` und `r round(conf_int[2], digits = 2)`. Das bedeutet, dass in 95% der Fälle in einer wiederholten Ziehung aus der Grundgesamtheit die mittleren Gewissenhaftigkeitswerte zwischen `r round(conf_int[1], digits = 2)` und `r round(conf_int[2], digits = 2)` liegen.
