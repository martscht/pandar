...
Der Datensatz besteht aus `r nrow(fb25)` Zeilen (Beobachtungen) und mindestens (unter Einbeziehung der Ergänzungen) `r ncol(fb25)` Spalten (Variablen). Falls Sie bereits weitere eigene Variablen erstellt haben, kann die Spaltenzahl natürlich abweichen.
...
```{r, echo=FALSE}
t_test2 <- t.test(fb25$offen, mu = 3.6, alternative = "greater")
