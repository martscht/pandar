...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-24-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-28-1.png)<!-- -->

```r
barplot(table_lerntyp, main = "Lerntypen Jahrgang 2022", ylab = "Anzahl Studierende", col = colours2)
```

![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-28-2.png)<!-- -->
</details>
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-31-1.png)<!-- -->

```r
boxplot(fb22$prok10)
```

![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-31-2.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-35-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-36-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-37-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-43-1.png)<!-- -->
</details>
...
Mit einer Irrtumswahrscheinlichkeit von 5% kann die $H_0$ verworfen und die $H_1$ angenommen werden. Die weiblichen Psychologie-Studierenden haben verglichen mit der Gesamtbevölkerung der Frauen höhere Gewissenhaftswerte.
Das 99%-ige Konfidenzintervall liegt zwischen 3.86 und $\infty$ (außerhalb des definierten Wertebereichs). Das bedeutet, dass in 99% der Fälle in einer wiederholten Ziehung aus der Grundgesamtheit die mittleren Verträglichkeitswerte zwischen 3.86 und $\infty$ (außerhalb des definierten Wertebereichs) liegen.
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-51-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-52-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-52-2.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-62-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-62-2.png)<!-- -->
...
Wir überprüfen optisch, ob die Messwerte der beiden Gruppen ungefähr der selben Verteilung folgen.
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-63-1.png)<!-- -->

```r
hist(fb22$intel[fb22$job == "nein"])
```

![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-63-2.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-70-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-71-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-71-2.png)<!-- -->
...
```
## Warning in cor.test.default(fb22$woerter_grund, fb22$gewis, method = "spearman", : Cannot compute exact p-value with
## ties
```
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-74-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-76-1.png)<!-- -->
...
![](pandar.git//lehre/statistik-i/stat-i-zusatz-loesungen_files/figure-html/unnamed-chunk-83-1.png)<!-- -->
