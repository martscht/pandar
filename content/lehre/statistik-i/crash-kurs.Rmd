...
```{r, echo = FALSE, purl = FALSE}
cat(paste(readLines('../../daten/fb24.csv')[1:5], collapse = '\n'))
```
...
fb24 <- read.table('../../daten/fb24.csv')
```
...
```
```{r, echo = FALSE, error = TRUE, purl = FALSE}
fb24 <- read.table('../../daten/fb24.csv', header = TRUE)
```
...
```
```{r, echo = FALSE, purl = FALSE}
fb24 <- read.table('../../daten/fb24.csv', header = TRUE, sep = ",")
```
...
```{r, echo = FALSE, purl = FALSE}
cat(paste(readLines('fb24.txt')[1:5], collapse = '\n'))
```
