...
```{r, echo = FALSE, purl = FALSE}
cat(paste(readLines('../../daten/fb23.csv')[1:5], collapse = '\n'))
```
...
fb23 <- read.table('../../daten/fb23.csv')
```
...
```
```{r, echo = FALSE, error = TRUE, purl = FALSE}
fb23 <- read.table('../../daten/fb23.csv', header = TRUE)
```
...
```
```{r, echo = FALSE, purl = FALSE}
fb23 <- read.table('../../daten/fb23.csv', header = TRUE, sep = ",")
```
...
```{r, echo = FALSE, purl = FALSE}
cat(paste(readLines('fb23.txt')[1:5], collapse = '\n'))
```
