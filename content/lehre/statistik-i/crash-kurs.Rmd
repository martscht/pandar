...
cat(paste(readLines('../../daten/fb22.csv')[1:5], collapse = '\n'))
```
...
fb22 <- read.table('../../daten/fb22.csv')
```
...
```
```{r, echo=FALSE, error = TRUE, purl = FALSE}
fb22 <- read.table('../../daten/fb22.csv', header = TRUE)
```
...
```
```{r, echo=FALSE, purl = FALSE}
fb22 <- read.table('../../daten/fb22.csv', header = TRUE, sep = ",")
```
