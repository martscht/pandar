...
summary: 'In diesem Beitrag wird die Kunst der Metaanalyse nähergebracht, in Anwendung mit dem Paket`metafor` auf einen Paket-internen Datensatz. Fixed und Random-Modelle sowie Modellvergleiche stehen im Fokus.' 
authors: [irmer]
weight: 1
lastmod: '`r Sys.Date()`'
featured: no
...
```{r,echo=FALSE, purl = F, fig.height=6, fig.align="center"}
...
```{r, fig.align="center", fig.height=6, echo = F, purl = F}
plot(NA, xlim = c(-2,2), ylim = c(-2,2), xlab = "Interview Performanz", ylab = "Job-Performanz",
     main = "Empirische Korrelationen zwischen\n Interview Performanz und Job-Performanz")
for(i in 1:length(dat.mcdaniel1994$ri))
{
...
```{r, fig.align="center", echo = F, purl = F}
