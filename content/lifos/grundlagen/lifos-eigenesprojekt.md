...
Nachdem ihr sowohl schon die Basics über LIFOS und <span style="color: darkred;">**GitLab**</span> erfahren habt und auch euer richtiges Template ausgewählt habt, ist es jetzt an der Zeit, dass ihr euer erstes eigenes Projekt erstellt. **Es ist hierbei äußerst wichtig, dass, sofern Ihr eine Abschlussarbeit durchführen wollt, Ihr bereits in der entsprechenden [Gruppe](/lifos/grundlagen/lifos-orientierung/#gruppen) der Abteilung seid bevor ihr euer Projekt erstellt!** 
...
Dieser Schritt ist sehr wichtig, da das Projekt auf jeden Fall zur richtigen Abteilung zugeordnet werden sollte! Falls ihr noch nicht der Gruppe eurer Abteilung angehört, lest nochmal im [Tutorial zur Orientierung](/lifos/grundlagen/lifos-orientierung) nach.
...
<span style="color:red">**Hinweis**</span>: Wenn ihr eure Daten hochladen wollt, lest euch zuerst unseren [Abschnitt zu Datenschutz](/lifos/grundlagen/lifos-datenschutz) durch, um sicherzustellen, dass eure Daten der nötigen Anonymität entsprechen! 
...
Jetzt öffnet sich die Web IDE und ihr habt die Möglichkeit das "README.md" zu bearbeiten. Aber wie ihr sehen könnt, ist es nicht einfach nur eine Textdatei. Das "README.md" ist in der Sprache Markdown geschrieben - deswegen auch ".md". Lasst euch davon nicht verunsichern! Eine Anleitung zu Markdown findet ihr in diesem Tutorial etwas weiter [unten](#basic-markdown-tutorial) und ihr könnt eure Markdown Fähigkeiten auch in einer [Übung](https://pandar.netlify.app/lifos/extras/lifos-r-markdown-uebung/) unter Beweis stellen.
...
Wenn ihr eine Übung zum Erstellen eines Dokumentes mit Markdown durchführen wollt, findet ihr [hier](https://pandar.netlify.app/lifos/extras/lifos-r-markdown-uebung/) dazu eine Anleitung.



### Fazit   

Dieses Tutorial hat euch erklärt wie ihr ein Projekt erstellen könnt, sowie Dateien und Ordner in diesem bearbeiten könnt. Ihr habt aber bestimmt selbst gemerkt, dass es noch viele andere verschiedenen Funktionen und Möglichkeiten gibt mit <span style="color: darkred;">**GitLab**</span> und dem LIFOS-Server zu arbeiten. Außerdem habt ihr die Basics von Markdown gelernt. Um euch die Arbeit mit <span style="color: darkred;">**GitLab**</span> einfacher zu machen, könnt ihr euch das <span style="color: darkred;">**SmartGit**</span> Tutorial anschauen. Dieses findet ihr [hier](https://pandar.netlify.app/lifos/extras/lifos-smartgit). Eine vertiefende Einführung zu <span style="color: darkred;">**GitLab**</span> findet ihr [hier](). 
