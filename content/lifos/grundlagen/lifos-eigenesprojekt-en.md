...
featured: no
banner:
  image: "/header/EigenesProjektLifos.jpg"
...
links:
  - name: EN
    url: /lifos/grundlagen/lifos-eigenesprojekt-en
  - name: DE
    url: /lifos/grundlagen/lifos-eigenesprojekt
...
This step is very important as the project should be assigned to the correct department! If you are not yet a member of your department's group, please refer back to the [Orientation Tutorial](/lifos/grundlagen/lifos-orientierung-en). 

### Datenschutz
<!-- soll ich das (Maria) auch machen? Wenn  ja wo finde ich die nötigen Informationen dazu, was man hochladen darf und was nicht? -->
<!-- Nein - Julia wird dazu was schreiben und sich auch noch entscheiden, in welches Tutorial es aufgenommen wird; könnte auch bei der Beschreibung der Templates passieren -->
...
<span style="color:red">**Note**</span>: If you want to upload your data, please read our [privacy section](/lifos/grundlagen/lifos-datenschutz) first to make sure that your data meets the necessary anonymity! 
...
We did not upload our file to a folder, but directly to the "homepage" of our project. In retrospect, we realize that the file should have been better placed in the "Scripts" folder. Normally, you would now move the file, but this is not possible on the browser version of <span style="color: darkred;">GitLab</span>. The only way to get the file into the folder is to delete it first and then upload it again. A more convenient option is provided by <span style="color: darkred;">SmartGit</span>. With <span style="color: darkred;">SmartGit</span>, you can greatly simplify your work with <span style="color: darkred;">GitLab</span>. After you have finished reading this tutorial (recommended!), you can learn more about <span style="color: darkred;">SmartGit</span> [here](#https://pandar.netlify.app/lifos/extras/smartgit-lifos/).
...
Now the Web IDE opens and you have the opportunity to edit the "README.md". But as you can see, it's not just a plain text file. The "README.md" is written in the Markdown language - that's why it's called ".md". Don't be intimidated by this! You can find a guide to Markdown in this tutorial a little further [down](#basic-markdown-tutorial), and you can also test your Markdown skills in an [exercise](https://pandar.netlify.app/lifos/extras/lifos-r-markdown-uebung-en/).
...
Instructions on how to delete your own projects (i.e., those without group affiliation) are described in the tutorial for the advanced Markdown exercise, which you can find [here](https://pandar.netlify.app/lifos/extras/lifos-r-markdown-uebung#deleting-a-project). However, a brief introduction to Markdown with descriptions of the most important functionalities is also provided here.
...
If you want to practice creating a document with Markdown, you can find instructions [here](https://pandar.netlify.app/lifos/extras/lifos-r-markdown-uebung-en/).



### Conclusion  

This tutorial has explained how to create a project and edit files and folders in it. However, you have probably noticed that there are many other functions and possibilities for working with <span style="color: darkred;">GitLab</span> and the LIFOS server. You have also learned the basics of Markdown. To make your work with <span style="color: darkred;">GitLab</span> easier, you can check out the <span style="color: darkred;">SmartGit</span> tutorial. You can find it [here](https://pandar.netlify.app/lifos/extras/smartgit-lifos/). A more in-depth introduction to <span style="color: darkred;">GitLab</span> can be found [here](). 
