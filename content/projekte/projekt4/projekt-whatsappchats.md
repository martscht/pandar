...
##   time                author
##   <dttm>              <fct> 
## 1 2019-06-23 18:21:10 <NA>  
## 2 2019-06-26 11:49:10 Frank 
## 3 2019-06-26 12:05:10 Marie 
## 4 2019-06-26 12:05:10 Hans  
## 5 2019-06-26 12:06:10 Georg 
## 6 2019-06-26 12:09:10 Petra 
## # ℹ 4 more variables:
## #   text <chr>, source <chr>,
## #   emoji <list>,
## #   emoji_name <list>
...
![](/projekte/projekt4/projekt-whatsappchats_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
![](/projekte/projekt4/projekt-whatsappchats_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
```
## Warning in breaks[-1L] +
## breaks[-nB]: NAs durch
## Ganzzahlüberlauf erzeugt
```

![](/projekte/projekt4/projekt-whatsappchats_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
```
## Warning: Use of `whatsapp$time` is
## discouraged.
## ℹ Use `time` instead.
```

![](/projekte/projekt4/projekt-whatsappchats_files/figure-html/unnamed-chunk-13-2.png)<!-- -->
...
![](/projekte/projekt4/projekt-whatsappchats_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
```
## Warning: Use of `whatsapp$uhrzeit` is
## discouraged.
## ℹ Use `uhrzeit` instead.
## Use of `whatsapp$uhrzeit` is
## discouraged.
## ℹ Use `uhrzeit` instead.
```

![](/projekte/projekt4/projekt-whatsappchats_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
## 4:                leider, sorry
## 5:                leider, sorry
## 6: blöd, kriegen, leider, sorry
## 7:    leider, schade, vermissen
##      terms_negation
## 1:      kein, nicht
## 2:            nicht
## 3:      kein, nicht
...
## 2:                       leider
## 3:                leider, sorry
## 4: blöd, kriegen, leider, sorry
## 5:                       leider
## 6:    leider, schade, vermissen
## 7:                leider, sorry
##      terms_negation
## 1:      kein, nicht
## 2:      kein, nicht
