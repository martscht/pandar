...
```
## Warning: Use of `whatsapp$time` is discouraged.
## ℹ Use `time` instead.
```
...
```
## Warning: Use of `whatsapp$uhrzeit` is discouraged.
...
```
##           levels.whatsapp.author. zeit Punkte
## Anna                         Anna  480      5
...
```
##    doc_id sentiment_polarity sentences terms      terms_positive terms_negative terms_negation
## 1:   doc1                 -3        21   525 gern, gut, ok, okay  leider, sorry    kein, nicht
##    terms_amplification
## 1:       bißchen, voll
```
...
```
##           levels.whatsapp.author. zeit Punkte senti Punkte2 final
