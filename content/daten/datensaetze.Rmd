...
search_rmd_dataset <- function(keyword, path = ".", name = "None") {
  ...
  # Move two folders down (adjust based on your project structure)
  setwd("../../")  # Moves up two levels to the project root
...
### Auftreten
`r search_rmd_dataset("raw_data", name ="Achtsamkeit und Depression")`
...
### Auftreten
`r search_rmd_dataset("alc.rda", name ="Alc")`
...
### Auftreten
`r search_rmd_dataset("StressAtWork.rda", name ="StressAtWork")`
...
### Auftreten
`r search_rmd_dataset("edu_exp.rda", name ="edu_exp")`
...
### Auftreten
`r search_rmd_dataset("fairplayer.rda", name ="fairplayer")`
...
### Auftreten
`r search_rmd_dataset("Depression.rda", name ="depression")`
...
### Auftreten
`r search_rmd_dataset("Big5_EFA.rda", name ="Big5")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_distort.R", name ="OSF distort")`
...
### Auftreten
`r search_rmd_dataset("F2F_CBT", name ="F2F_CBT")`
...
### Auftreten
`r search_rmd_dataset("Assessment.rda", name ="Assessment")`
...
### Auftreten
`r search_rmd_dataset("WorldPopulation.rda", name ="WorldPopulation")`
...
### Auftreten
`r search_rmd_dataset("ecr.rda", name ="ecr")`
...
### Auftreten
`r search_rmd_dataset("fb22.rda", name ="fb22")`
...
### Auftreten
`r search_rmd_dataset("fb23.rda", name ="fb23")`
...
### Größe
Der Datensatz besteht aus `r dim(fb24)[1]` Beobachtungen auf `r dim(fb24)[2]` Variablen.
...
### Fehlende Werte
Insgesamt liegen im Datensatz `r sum(is.na(fb24))` fehlende Werte vor. Folgende Variablen enthalten keine fehlenden Werte:
...
### Auftreten
`r search_rmd_dataset("fb24.rda", name ="fb24")`
...
### Größe
Der Datensatz besteht aus `r dim(fb25)[1]` Beobachtungen auf `r dim(fb25)[2]` Variablen.
...
### Fehlende Werte
Insgesamt liegen im Datensatz `r sum(is.na(fb25))` fehlende Werte vor. Folgende Variablen enthalten keine fehlenden Werte:
...
### Auftreten
`r search_rmd_dataset("prc92", name ="OSF Gender, Drug and Depression")`
...
### Auftreten
`r search_rmd_dataset("molloy2014.rda", name ="data_combined")`
...
### Auftreten
`r search_rmd_dataset("PCA.RData", name ="PCA")`
...
### Größe
Der Datensatz besteht aus `r dim(HeckData)[1]` Beobachtungen auf `r dim(HeckData)[2]` Variablen.
...
### Fehlende Werte
Im Datensatz liegen `r 10000 - sum(HeckData$s)` "fehlende Werte" auf der Variable `Y_obs` vor.

<!-- </details> -->

### Auftreten
`r search_rmd_dataset("HeckData.rda", name ="HeckData")`
...
### Auftreten
`r search_rmd_dataset("zc8ut", name ="OSF Internetintervention für psychische Störungen")`
...
### Auftreten
`r search_rmd_dataset("43xv5", name ="body")`
...
<!-- </details> -->
### Auftreten
`r search_rmd_dataset("Data_Processing_conspiracy_cfa.R", name ="conspiracy_cfa")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_punish.R", name ="punish")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_KliPPsQuiz1.R", name ="trauma")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_KliPPsQuiz2.R", name ="lockdown")`
...
### Größe
Der Datensatz besteht aus `r dim(fall)[1]` Beobachtungen auf `r dim(fall)[2]` Variablen.
...
### Auftreten
`r search_rmd_dataset("Data_Processing_fall.R", name ="fall")`
...
### Auftreten
`r search_rmd_dataset("PISA2009.rda", name ="PISA2009")`
...
### Auftreten
`r search_rmd_dataset("mach.rda", name ="mach")`
...
### Auftreten
`r search_rmd_dataset("g6ya4", name ="Major Depression (data)")`
...
### Auftreten
`r search_rmd_dataset("mdbf.rda", name ="mdbf")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_Quiz4b.R", name ="Mental Health and Social Contact During the COVID-19 Pandemic (data)")`
...
### Auftreten
`r search_rmd_dataset("nature.rda", name ="nature")`
...
### Auftreten
`r search_rmd_dataset("NerdData.rda", name ="NerdData")`
...
### Auftreten
`r search_rmd_dataset("qev5n", name ="burnout")`
...
### Auftreten
`r search_rmd_dataset("dc6me", name ="lockdown")`
...
### Auftreten
`r search_rmd_dataset("CBTdata.rda", name ="CBTdata")`
...
### Auftreten
`r search_rmd_dataset("Schulleistungen.rda", name ="Schulleistungen")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_conspiracy.R", name ="conspiracy")`
...
### Auftreten
`r search_rmd_dataset("StudentsInClasses.rda", name ="StudentsInClasses")`
...
### Auftreten
`r search_rmd_dataset("Therapy.rda", name ="Therapy")`
...
### Auftreten
`r search_rmd_dataset("Titanic.rda", name ="Titanic")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_Quiz1.R", name ="trauma")`
...
```
```{r, echo = FALSE}
source('./Data_Processing_trivia.R')
```
...
Der Datensatz besteht aus `r nrow(trivia)` Beobachtungen auf `r ncol(trivia)` Variablen. Der Datensatz liegt im long-Format vor, mit zehn Beobachtungen (eine pro Aussage) für jede Person.
...
### Auftreten
`r search_rmd_dataset("Data_Processing_trivia.R", name ="trivia")`
...
### Auftreten
`r search_rmd_dataset("Data_Processing_vegan.R", name ="vegan")`
...
### Auftreten
`r search_rmd_dataset("Behandlungsform.rda", name ="Behandlungsform")`
...
### Auftreten
`r search_rmd_dataset("Xmas.rda", name ="Xmas")`